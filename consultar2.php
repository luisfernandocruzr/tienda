...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="70" width="70">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">INVENTARIO TIENDA 2</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">REGISTRAR  PRODUCTOS TIENDA 2</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">NombreCorto Producto</th>
    ...
    <?php
          ...
          $consulta= "CALL sp_ver_productos()";
            //Ejecutamos la consulta
             ...
             while($producto = mysqli_fetch_array($result)){
              echo '<tr>
                        ...
                        <td>'.$producto[11].' </br>
                        <td>'.$producto[12].' </br>
                        <td><a href="frmeditarProducto.php?clave='.$producto[0].'"><i class="fas fa-edit" title="Editar"></i>
                        <td><a href="eliminarProducto.php?clave='.$producto[0].'"><i class="fas fa-trash-alt" title="Eliminar"></i></a>
